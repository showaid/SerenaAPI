...
/**
 * Example of how to update the HTML data format to be text.
 */
public final class UpdateFormat {
	...
	public static void main(final String[] args) {
		...
		try {
			// get the dmpmcli-style database.
			final DimensionsDatabaseAdmin defaultDatabase = connection
					.getObjectFactory().getBaseDatabaseAdmin();
			final FileFormats formats = defaultDatabase.getFileFormats();
			final FileFormat format = formats.get("HTML");
			// only ASCII and BINARY are relevant in Dimensions 10.
			format.setType(FileFormatType.ASCII);
			// persist the change made in the Java object to the Dimensions
			// database.
			format.save();
		} finally {
			// disconnect.
	...
	private static void usage() {
		System.err.println("java " + UpdateFormat.class.getName() + " \\");
