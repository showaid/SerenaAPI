...
/**
 * Represents the getitem nested element.
 * Should be just a simple JavaBean.
 */
public final class GetCopy implements NestedElement {
	...
	/**
	 * Creates a new GetCopy nested element.
	 */
	GetCopy(DimensionsTask task) {
		this.task = task;
	}
	...
	public final void execute() {
        try {
            Util.getCopy(
            		task.getConnection(), this.getSrcProject(),
            		this.getSrcPath(), this.getSrcItem(),
            		this.getDestPath(), this.isExpand(),
            		this.isRecursive());
        } catch (Exception e) {
     ...
     * @param destPath the folder on disk to
     *      which items will be written.
     */     
     ...
     * @param expand true if substitution variables
     *          should be expanded, false if not.
     */
	 ...
	 * @param recursive true if the nested element is recursive, false if not.
	 */
    ...
    /**
     * Gets the srcItem attribute for this nested element.
     * @return the srcItem attribute for this nested element.
     */
    public final String getSrcItem() {
        return this.srcItem;
    }

    /**
     * Sets the srcItem attribute for this nested element.
     * @param srcItem the name of the item to fetch.
     */
    public final void setSrcItem(final String srcItem) {
     ...
     * @param srcProject the name of the project from
     *      which items will be fetched
     */
