...
/**
 * Example of how to display the current user's user ID.
 */
public final class UserName {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			// display some details of the current user.
			System.out.println("User ID is \"" + userObj.getName() + "\"");
			System.out.println("Full name is \"" + userObj.getFullUserName()
					+ "\"");
		} finally {
			// disconnect.
			connection.close();
	...
	private static void usage() {
		System.err.println("java " + UserName.class.getName() + " \\");
