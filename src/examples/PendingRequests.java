...
/**
 * Example of displaying the current user's Request Inbox (pending requests).
 */
...
//		}
	...
	static void pendingRequests(final DimensionsConnection connection) {
		// get the current user.
		User userObj = connection.getObjectFactory().getCurrentUser();

		// get the pending list.
		List list = userObj.getPendingRequests();
	...
	private static void usage() {
		System.err.println("java " + PendingRequests.class.getName() + " \\");
